...
//front
   _cube[0] = Vertex({0.5, 0.5, 0.5}, {0, 0, 1}, {1, 0}, lightValue);
   _cube[1] = Vertex({-0.5, 0.5, 0.5}, {0, 0, 1}, {0, 0}, lightValue);
   _cube[2] = Vertex({-0.5, -0.5, 0.5}, {0, 0, 1}, {0, 1},lightValue);
   
   _cube[3] = Vertex({0.5, 0.5, 0.5}, {0, 0, 1}, {1, 0},lightValue);
   _cube[4] = Vertex({-0.5, -0.5, 0.5}, {0, 0, 1}, {0, 1} , lightValue);
   _cube[5] = Vertex({0.5, -0.5, 0.5}, {0, 0, 1}, {1, 1}, lightValue);
    
//back
    _cube[6] = Vertex({-0.5, 0.5, -0.5}, {0, 0, -1}, {1, 0}, lightValue );
    _cube[7] = Vertex({0.5, 0.5, -0.5,}, {0, 0, -1}, {0, 0}, lightValue);
    _cube[8] = Vertex({0.5, -0.5, -0.5}, {0, 0, -1}, {0, 1}, lightValue);

    _cube[9] = Vertex({-0.5, 0.5, -0.5}, {0, 0, -1}, {1, 0}, lightValue);
    _cube[10] = Vertex({0.5, -0.5, -0.5}, {0, 0, -1}, {0, 1}, lightValue);
    _cube[11] = Vertex({-0.5, -0.5, -0.5}, {0, 0, -1}, {1, 1}, lightValue);
    
//down
    _cube[12] = Vertex({0.5, -0.5, 0.5}, {0, -1, 0}, {1, 0}, lightValue);
    _cube[13] = Vertex({-0.5, -0.5, 0.5,}, {0, -1, 0}, {0, 0}, lightValue);
    _cube[14] = Vertex({-0.5, -0.5, -0.5}, {0, -1, 0}, {0, 1}, lightValue);

    _cube[15] = Vertex({0.5, -0.5, 0.5}, {0, -1, 0}, {1, 0}, lightValue);
    _cube[16] = Vertex({-0.5, -0.5, -0.5}, {0, -1, 0}, {0, 1}, lightValue);
    _cube[17] = Vertex({0.5, -0.5, -0.5}, {0, -1, 0}, {1, 1}, lightValue);

//up
    _cube[18] = Vertex({0.5, 0.5, -0.5}, {0, 1, 0}, {1, 0}, lightValue);
    _cube[19] = Vertex({-0.5, 0.5, -0.5,}, {0, 1, 0}, {0, 0}, lightValue);
    _cube[20] = Vertex({-0.5, 0.5, 0.5}, {0, 1, 0}, {0, 1}, lightValue);
    
    _cube[21] = Vertex({0.5, 0.5, -0.5}, {0, 1, 0}, {1, 0}, lightValue);
    _cube[22] = Vertex({-0.5, 0.5, 0.5}, {0, 1, 0}, {0, 1}, lightValue);
    _cube[23] = Vertex({0.5, 0.5, 0.5}, {0, 1, 0}, {1, 1}, lightValue);

//left
    _cube[24] = Vertex({-0.5, 0.5, 0.5}, {-1, 0, 0}, {1, 0}, lightValue);
    _cube[25] = Vertex({-0.5, 0.5, -0.5,}, {-1, 0, 0}, {0, 0}, lightValue);
    _cube[26] = Vertex({-0.5, -0.5, -0.5}, {-1, 0, 0}, {0, 1}, lightValue);
    
    _cube[27] = Vertex({-0.5, 0.5, 0.5}, {-1, 0, 0}, {1, 0}, lightValue);
    _cube[28] = Vertex({-0.5, -0.5, -0.5}, {-1, 0, 0}, {0, 1}, lightValue);
    _cube[29] = Vertex({-0.5, -0.5, 0.5}, {-1, 0, 0}, {1, 1}, lightValue);

//right
    _cube[30] = Vertex({0.5, 0.5, -0.5}, {1, 0, 0}, {1, 0}, lightValue);
    _cube[31] = Vertex({0.5, 0.5, 0.5,}, {1, 0, 0}, {0, 0}, lightValue);
    _cube[32] = Vertex({0.5, -0.5, 0.5}, {1, 0, 0}, {0, 1}, lightValue);
    
    _cube[33] = Vertex({0.5, 0.5, -0.5}, {1, 0, 0}, {1, 0}, lightValue);
    _cube[34] = Vertex({0.5, -0.5, 0.5}, {1, 0, 0}, {0, 1}, lightValue);
    _cube[35] = Vertex({0.5, -0.5, -0.5}, {1, 0, 0}, {1, 1}, lightValue);
